		...
		<div class="max-w-screen-xl px-4 pt-4 mx-auto lg:pt-8 lg:px-6">
			<div class="max-w-screen-md mx-auto mb-6 text-center lg:mb-8">
				...
				<p class="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-400">
					Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed rutrum pretium lobortis. Etiam arcu sapien, pharetra sit amet nibh
					quis, venenatis tincidunt est.
				</p>
